  ...
  return (
    <div className="container">
      <div className="page-header">
        <div>
          <h1>错误自省</h1>
          <p className="text-muted text-sm">查看任务失败分类、根因分析与修复建议</p>
        </div>
        <NavBar />
      </div>
      ...
      <div className="card mb-4">
        <div className="filters">
          <div className="form-group">
            <label className="text-sm">错误分类</label>
          ...
          <div className="form-group">
            <label className="text-sm">解决状态</label>
              ...
              <tbody>
                {data.items.map((item) => (
                  <tr key={item.id}>
                    ...
                    <td>
                      <button className="btn secondary small" onClick={() => setSelected(item)}>
                        详情
                      </button>
                    </td>
                  </tr>
